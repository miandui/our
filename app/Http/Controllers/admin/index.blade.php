...
<html>
    ...
    <body>
        <div class="layui-layout layui-layout-admin">
            <div class="layui-header header header-demo">
                <div class="layui-main">
                   ...
                   <img src="{{URL::asset('images/banner2.png')}}"></img>
                    </a>
                    <ul class="layui-nav" lay-filter="">
                      <li class="layui-nav-item"><img src="{{URL::asset('images/0.jpg')}}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" alt=""></li>
                ...
                <div class="layui-side-scroll">
                    ...
                    <!--数据管理-->
                      ...
                      <dl class="layui-nav-child">
                                ...
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="shujutongji.html">
                                            <cite>数据统计</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <!--用户管理-->
                        <li class="layui-nav-item">
                            <a class="javascript:;" href="javascript:;" _href="{{URL::asset('admin/user')}}">
                                <i class="layui-icon" style="top: 3px;">&#xe613;</i><cite>用户管理</cite>
                            </a>
                        </li>
                        <!--角色管理-->
                        <li class="layui-nav-item">
                            <a class="javascript:;" href="javascript:;" _href="{{URL::asset('admin/role')}}">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="{{URL::asset('./Home.blade.php')}}">
            ...
            <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
                ...
                <div class="layui-tab-content site-demo site-demo-body">
                    <div class="layui-tab-item layui-show">
                        <iframe frameborder="0" src="{{URL::asset('admin/main')}}" class="x-iframe"></iframe>
                    </div>
                </div>
            </div>
        ...
        <script src="{{URL::asset('./js/x-admin.js')}}"></script>
        <script>
        var _hmt = _hmt || [];
        (function() {
