...
<html>
    ...
    <body>
            ...
            <table class="layui-table">
                ...
                <?php foreach($data as $val):?>
                    <tr>
                        ...
                        <td><u style="cursor:pointer" onclick="user_management_show('<?= $val['user_number']?>','{{URL::asset('admin/user_show')}}','10001','360','400')"><?= $val['user_number']?></u></td>
                        <td >
                        <?= $val['user_password']?></td>
                        <?php if($val['user_vip']==1):?>
                             <td >会员</td>
                         <?php else:?>
                            <td >非会员</td>
                        <?php endif;?>
                        ...
                        <td class="td-status">
                            <?php if($val['user_state']==1):?>
                             <span class="layui-btn layui-btn-normal layui-btn-mini" id="layui" value="<?= $val['user_id']?>" state="0">
                                已启用
                            </span>
                         <?php else:?>
                            <span class="layui-btn layui-btn-normal layui-btn-mini" id="layui" value="<?= $val['user_id']?>" state="1">
                                未启用
                            </span>
                        <?php endif;?>
                        </td>
        ...
        <script>
            $(document).on('click','#layui',function(){
